...
exports.getProviderSLA = exports.validateCheckIn = void 0;
...
const getProviderSLA = async (req, res) => {
    ...
    try {
        ...
        if (tickets.length === 0)
            return res.json({ slaScore: 100, pendingTickets: 0 });
        const totalResponseTime = tickets.reduce((acc, t) => {
...
exports.getProviderSLA = getProviderSLA;
